...
var Adder = require("./panels/Adder.js")
var Multiplier = require("./panels/Multiplier.js")
var Randomizer = require("./panels/Randomizer.js")
var Imgr = require("./panels/Imgr.js")
        ...
        <div className="row">
          ...
          */}
          <div className="col-md-3">
            ...
            <Adder clicks={this.state.clicks * 1} />
          ...
          <div className="col-md-3">
            ...
            {/* Add code to render the Multiplier component here */}
              <Multiplier clicks={this.state.clicks * 2} />
          ...
          <div className="col-md-3">
            ...
            <Randomizer clicks={this.state.clicks * 1} />
          ...
          <div className="col-md-3">
             ...
             <Imgr clicks={this.state.clicks * 1}/>
          </div>
