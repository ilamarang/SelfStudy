...
var Imgr = React.createClass({
  ...
  componentWillReceiveProps: function() {
    console.log("Component has recieved props!");
    // This method runs each time this component receives new props
    // Add code here to set this.state.selection equal to a random index of the this.state.src array
    this.state.selection = (Math.floor(Math.random() * this.state.src.length)  )
  },
  render: function() {
    return (
      <div className="panel panel-default">
        ...
        <div className="panel-body">
          ...
          {/* Set the src attribute of this img tag to the url at the index of the random selection  */}
          <img alt="Random Selection" width="100%" src={this.state.src[this.state.selection]}/>
